...
/**
 * 自定义 RollingFileAppender，每天产生一个日志文件夹
 */
public class GLog4jRollingFileAppender extends RollingFileAppender {
    ...
    public synchronized void setFile(String fileName, boolean append, boolean bufferedIO, int bufferSize) throws IOException {
        ...
        File datePath = new File(f.getParent());
        datePath.mkdirs();
